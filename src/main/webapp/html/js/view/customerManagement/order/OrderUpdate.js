Ext.define('CRM.view.customerManagement.order.OrderUpdate',
    {
        extend : 'Ext.window.Window',
        alias : 'widget.orderUpdate',
        layout : 'fit',
        id:'orderUpdate',
        autoShow : true,
        height : 650,
        ...
        initComponent : function() {
            ...
            this.contactStoreAll = Ext
                    .create('CRM.store.customerManagement.order.OrderCutomerContactStore');
            this.contactStoreAll.load();
            this.contactStoreById = Ext
            .create('CRM.store.customerManagement.order.OrderCutomerContactStore');
                ...
                items :[{
                    ...
                    items : [ {
                        ...
                        tpl : Ext.create(
                            'Ext.XTemplate',
                            '<ul><tpl for=".">',
                            '<li role="option" class="x-boundlist-item">{[Ext.htmlEncode(values.value)]}</li>',
                            '</tpl></ul>'
                        )                        
                    } ]
                },{
                    ...
                    items :[{
                        ...
                        blankText : "客户名称不能为空！",
                        store : Ext.create(
            'CRM.store.customerManagement.customerProfiles.CustomerName'),
                        forceSelection : true,
                        ...
                        tpl : Ext.create(
                            'Ext.XTemplate',
                            '<ul><tpl for=".">',
                            '<li role="option" class="x-boundlist-item">{[Ext.htmlEncode(values.customerName)]}</li>',
                            '</tpl></ul>')
                    },{
                        allowBlank : false,
                    ...
                    items :[{
                        ...
                        tpl : Ext.create(
                            'Ext.XTemplate',
                            '<ul><tpl for=".">',
                            '<li role="option" class="x-boundlist-item">{[Ext.htmlEncode(values.contactName)]}</li>',
                            '</tpl></ul>')
                    },{
                        xtype : 'textfield',
                        margin : '0 0 0 15',
                        ...
                        items :[{
                            ...
                            items : [ {
                                ...
                                tpl : Ext.create(
                                    'Ext.XTemplate',
                                    '<ul><tpl for=".">',
                                    '<li role="option" class="x-boundlist-item">{[Ext.htmlEncode(values.eventName)]}</li>',
                                    '</tpl></ul>'
                                )
                            },{
		                        margin:'5 20 0 0',
